...
$pdf->Cell(50,5,'PRODUCT',1,0,'C'); //100
...
$pdf->Cell(50,5,$item->product_name,1,0,'L'); //100
...
$pdf->SetX(7);
$pdf->SetFont('Courier','B',8);
$pdf->Cell(90,5,'Thankyou for choosing',0,1,'C');//100
...
$pdf->Cell(90,3,'Dzaeri, Tserimea, Foshisha',0,1,'');


$pdf->SetX(7);
$pdf->SetFont('Courier','BI',8);
$pdf->Cell(90,3,'Contact at : 4438',0,1,'');
