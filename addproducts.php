    ...
    if ($countDuplicate > 0) {
        ...
        if ($image["error"] === UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($image["tmp_name"], $imagePath)) {
                ...
                $insert = $pdo->prepare("INSERT INTO tbl_product (pname, pcategory, saleprice, pstock, image) VALUES (:pname, :pcategory, :saleprice, :pstock, :image)");
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $select->fetch(PDO::FETCH_OBJ)) {
                                        echo "<tr>
                                            <td class='justify-center' style='text-align: center;'>$row->pid</td>
                                        ...
                                        if (isset($row->image) && !empty($row->image)) {
                                            ...
                                            echo "No Image Available"; // Display a message when the image is not available
                                        }
                                        ...
                                        echo "</td>
                                            ...
                                            class= \"btn btn-danger dltBttn \" type=\"button\" ><span class=\"fas fa-trash\"   style=\"color:#ffffff\" data-toggle=\"tooltip\" title=\"DELETE Order\"></span>
                                                ...
                                                <a href=\"Editproduct.php?id=" . $row->pid . "\" class=\"btn btn-info\" role=\"button\"><span class=\"fas fa-edit\" name=\"editBtn\" style=\"color:#ffffff\" data-toggle=\"tooltip\" title=\"EDIT\"></span>
                                                </td>
                                            </tr>";
                                    }
                                    ?>
