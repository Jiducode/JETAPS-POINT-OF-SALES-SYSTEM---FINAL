...
<iframe width="649" height="323" frameborder="0" scrolling="no" src="https://onedrive.live.com/embed?resid=1BDBE8B3BA52B1AD%21248923&authkey=%21AEsflfwOxuGwOCQ&em=2&wdAllowInteractivity=False&Item=Chart%201&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True&edesNext=false&resen=true&ed1JS=false"></iframe>
   ...
   <div class="col-xl-4 col-lg-5">
       <div class="card shadow mb-4">
           ...
           <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
               <h6 class="m-0 font-weight-bold text-primary">Total Residents living at Tula and Lourdes:</h6>
