...
$pdf->Cell(60,5,'Contact : 4438',0,1,'C');
$pdf->Cell(60,5,'E-mail Address : jetapsemail@gmail.com',0,1,'C');
...
$pdf->Cell(75,5,'JETAPS | POS',0,1,'C');



$pdf->SetX(3);
$pdf->SetFont('Courier','B',12);
$pdf->Cell(75,5,"Please Come Again",0,1,'C');
...
$pdf->Cell(75,3,'Dzaeri, Tserimea, Foshisha',0,1,'');


$pdf->SetX(7);
$pdf->SetFont('Courier','BI',8);
$pdf->Cell(75,3,'Contact at : 4438',0,1,'');
